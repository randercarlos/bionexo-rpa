        ...
        try {
            ...
            foreach($pageDivs as $pageDiv) {
                ...
                $pdfExtractedData[] = [
                    ...
                    'Senha' => $this->getTextFromContent("#$elementId p:nth-child(92)"),
                    ...
                    'Código da Glosa da Guia' => $this->getTextFromContent("#$elementId p:nth-child(55)"),
                    'Data de realização' => $this->getTextFromContent("#$elementId p:nth-child(28)"),
                    'Tabela' => $this->getTextFromContent("#$elementId p:nth-child(29)"),
                    ...
                    'Grau Participação' => $this->getTextFromContent("#$elementId p:nth-child(56)"),
